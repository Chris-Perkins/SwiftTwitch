//
//  GetGameAnalyticsReportData.swift
//  NewTwitchAPIWrapper
//
...
public struct GetGameAnalyticsReportData: Unmarshaling {
    ...
    /// Initializes a `GetGameAnalyticsReportData` object from the input `MarshaledObject`.
