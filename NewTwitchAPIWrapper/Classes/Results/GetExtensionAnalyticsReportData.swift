//
//  GetExtensionAnalyticsReportData.swift
//  NewTwitchAPIWrapper
//
...
/// `GetExtensionAnalyticsReportData` holds data about the different reports that are returned by
/// Twitch. This will contain the URL, the ID of the extension being reported on, and other details
/// about the report.
public struct GetExtensionAnalyticsReportData: Unmarshaling {
